...
st.write('Every mechanism has strengths and weaknesses. COCM is good at **prioritizing the voices of real people and core community members, or any donor who takes the time to craft a unique slate of donations**. COCM is harder to sybil attack than QF.')
st.write('However, COCM also **reduces the impact that single-issue voters have**, and **reduces the impact that groups of similar voters have**. Sometimes, single issue voters and voters with similar donation patterns constitute the newest members of a community, so COCM is not ideal for prioritizing those voices.')
st.write('It\'s also worth noting that **COCM almost always gives a "flatter" funding distribution than QF** -- whether this is good or bad depends on your perspective and the needs of your round.')
